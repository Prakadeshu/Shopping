...
<head>
    ...
    <script>
        ...
        function validateForm() {
            ...
            // Get form values
            let name = document.forms["editClientForm"]["name"].value;
            let email = document.forms["editClientForm"]["email"].value;
            let phone = document.forms["editClientForm"]["phone"].value;
            let address = document.forms["editClientForm"]["address"].value;
            ...
            return valid; // If validation fails, prevent form submission
        }
    </script>
</head>
<body>
    <div class="container my-5">
        ...
        ?>
        <form name="editClientForm" onsubmit="return validateForm()" method="post">
